...
https://aliexpress.ru/item/1005003640070178.html<br><br>
...
Пример:<br>
ПС4 1<br>
ХВОХ4 2 (набрано на кириллице)<br><br>

3. Создать приложение яндекса, и получить токен на управление оборудованием "яндекс умный дом".<br>
Как это сделать смотрите тут: https://www.youtube.com/watch?v=zHcx-TD4ZPU<br><br>

4. Настроить конфиг в файле<br>
...
```
<br><br>
5. Закинуть файл на веб хостинг, либо понять сервер на компьютере администратора с помощью того же openserver (https://ospanel.io/)<br><br>

6. Создать задания в планировщике задач<br><br>
